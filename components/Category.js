...
export default function Category() {
    return (
        <div className='lg:px-20 px-4 mt-20 bg-white'>
            ...
            <div className='grid lg:grid-cols-4 grid-flow-row gap-8'>
                {categories.map((cat, index) => {
                    return (
                        <div
                            className='flex gap-4 items-center bg-[#f0f0f9] px-6 py-2 rounded-md hover:bg-[#0071DC] hover:text-white transition-colors duration-300 ease-linear cursor-pointer'
                            key={index}
                        >
